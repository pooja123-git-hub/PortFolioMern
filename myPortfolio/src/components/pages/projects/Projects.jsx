...
const Projects = () => {
  return (
    <Container className='projects' id='project'>
      <h2 className='col-12 mt-3 mb-1 text-uppercase heading2'>Top Recent Projects</h2>
      <hr />
     <motion.p
...
<Row className="gx-4 gy-4">
  ...
  <Col md={4}>
   <motion.div
  className="project-card card h-100 rounded" initial={{ opacity: 0, x: -50 }}
  ...
  transition={{ duration: 0.6, ease: 'easeOut' }}>
      ...
      <div>
        ...
        <div className="card-body text-center">
          ...
          <a className="ad-btn" href="https://github.com/pooja123-git-hub/React-Basic-Project">View</a>
        </div>
      </div></motion.div>
  </Col>
  ...
  transition={{ duration: 0.6, ease: 'easeOut' }}>
      ...
      <div>
        ...
        <div className="card-body text-center">
          ...
          <a className="ad-btn" href="https://github.com/pooja123-git-hub/Game-App-Rock-Paper-Scissors-">View</a>
        </div>
      </div>
</motion.div>
  </Col>
